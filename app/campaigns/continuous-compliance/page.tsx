...
export default function ContinuousCompliancePage() {
  ...
  const { openRows, completeRows } = useMemo(() => {
    ...
    rows.forEach((r) => {
      ...
      // If date is missing/unparseable, keep in Open by default.
      if (!d) {
        open.push(r);
        return;
      }
      if (d < today) complete.push(r);
      else open.push(r);
    });
  ...
  const columnDefs: ColDef[] = [
    ...
    },
    {
      ...
      cellRenderer: (params: ICellRendererParams) => {
        ...
        const hasSuspend = has(/suspend/i);
          ...
          >
            ...
            {hasSuspend && (
              <button
                ...
                title="Suspend"
                aria-label="Suspend"
                className="p-1 rounded transition-colors duration-200 hover:bg-yellow-50"
            ...
            <div role="tabpanel" className="mt-4 flex flex-col">
              <div className="w-full flex flex-col">
                ...
                <div className="ag-theme-alpine w-full">
                  <AgGridReact
                    theme="legacy"
                    rowData={activeTab === 0 ? filteredOpenRows : filteredCompleteRows}
